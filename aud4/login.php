...
<div class="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
    <h2 class="text-2xl font-bold mb-4 text-center text-gray-800">Најави се</h2>
    ...
    <p class="text-center text-gray-600 mt-4">
        Немате акаунт? <a href="register.php" class="text-blue-500 hover:underline">Регистрирајте се тука</a>
    </p>
</div>
</body>
</html>
